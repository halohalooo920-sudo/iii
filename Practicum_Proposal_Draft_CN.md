...
| 0:55–1:00 | 录音/录像说明 | 说明课程要求对部分 session 进行 audio/video recording（仅用于督导训练目的）；重申录像仅督导和课程同学可看、学期结束后销毁；确认成员已在 consent form 上签署同意；提醒任何时候可以撤回同意 |
| 1:00–1:10 | 休息 | |
| 1:10–1:35 | Needs check-in | 每人在 Miro 个人区贴出："我希望从这个小组带走什么"+"我害怕这个小组变成什么"。轮流分享，带领者反映+整合 |
| 1:35–1:55 | Concern 激活活动："我的现状地图" | 每人在 Miro 上画一个简单的 timeline（过去 1 年 → 现在 → 未来 1 年），标出：(1) 关于未来已经做过哪些思考/尝试 (2) 现在卡在哪里 (3) 未来 1 年最希望发生什么。带领者强调："来到这里就是 Concern 的表现" |
| 1:55–2:00 | 整合 + Closing | 带领者 reflect 整组主题（不评判，只看见模式）。一句话 check-out + 小作业布置 |
...
| 1:20–1:30 | Values 之间的冲突 | 带领者引导："你的 Top 5 之间有没有彼此打架的？比如'安稳'和'自由'、'孝顺'和'自主'？"。每人标出 1 对冲突 values，写下：当这两个打架的时候，我平时是怎么处理的？。不急于解决，只是看见它 |
| 1:30–1:50 | "无限制"想象 + 双人分享 | 引导冥想 5 分钟："如果没有任何限制——钱、家庭期待、社会眼光——你 35 岁早晨醒来，看见什么？做什么？"。然后 dyads 互讲 |
...
**Miro 输出物**
- 个人区 S4 区块：Top 5 values（带描述）+ 来源标注（自己的/外部植入的）+ 标出 1 对冲突 values
...
**带领者框架参考：Career Counselling Domains 图**
> 在开始整合之前，带领者内部参照 career counselling domains 框架图（督导推荐；待确认具体 reference）来理解成员到目前为止走过的旅程。这张图展示 career exploration 的各个 elements（interests, values, strengths, personality, life roles, information, decision-making 等）以及它们之间的关系。带领者不需要向成员正式展示此图，但用它来 (1) 确认成员已完成哪些 elements 的探索，(2) 判断还有什么遗漏需要在讨论中自然补充，(3) 在 S5 整合环节帮成员把各 elements 连起来看。如果成员在整合时"说不出什么"，可以用此图作为提示框架引导。

**预备材料**
- Miro 模板：每人一块 integration zone（拉来 S2/S3/S4 的内容并排展示），右侧空白等候 possible selves
- "Possible selves" 引导卡：5 张提示卡（往外推 / 往内收 / 跨界 / 极端 / 平凡）
- Career Construction Interview 三问卡片（崇拜人物 / 最爱故事 / 座右铭）
...
| 1:35–1:50 | 收敛 | 回到个人 Miro，从 10 个里圈出 2-3 个"让我有点心动/有点害怕（两者都是信号）"的 possible self |
...
- "你小时候最崇拜的人物身上什么特质最吸引你？那个特质跟你现在想走的方向有关系吗？"
