...
|---|---|---|---|---|---|---|
| **1** | — | 进入 | 开场与连接 | "你为什么来？关于未来方向你已经做过哪些思考或尝试？" | 破冰；Group norms；Needs check-in；Miro：我的现状 | Concern（评估+激活） |
| **2** | Organize | 向内看 | 我喜欢什么 / 什么让我有能量 | "什么东西让你做起来不累、甚至兴奋？" | Interests 探索（RIASEC讨论）；回忆 flow 时刻 | Curiosity |
| **3** | Organize | 向内看 | 我擅长什么 / 我的优势 | "别人经常找你帮什么忙？你做什么比别人轻松？" | Strengths/Skills 清单；Strengths Spotting | Curiosity |
...
> 详细的 9 次 session 流程设计（包含时间分配、操作要点、活动指南）见独立文件：
> **[Session_Designs_Revised.md](Session_Designs_Revised.md)**
>
> 该文件包含：
> - 所有 9 次 session 的详细 run-down（无固定休息、减少带领者讲话时间）
> - 附录 Activity Guide：逐一解释 RIASEC 讨论、Flow 时刻回忆、Zoom 分组操作、Values Card Sort、Strengths Spotting、Barriers & Supports 四象限表、NVC 四组件教学、角色扮演的操作步骤和引导反馈方法
