...
According to Career Construction Theory (Savickas, 2005, 2013), individuals actively construct their careers through three core processes: organizing themselves (understanding who they are), imposing direction on their vocational behavior (deciding where to go), and making meaning of their careers (understanding why it matters). To carry out these processes effectively, individuals draw on Career Adaptability resources — specifically Concern (planfulness toward the future), Control (assuming responsibility for one's career), Curiosity (exploring possible selves and opportunities), and Confidence (believing in one's ability to make viable decisions) (Savickas & Porfeli, 2012).

However, for young adults in the emerging adulthood stage (Arnett, 2000) — particularly in the Chinese cultural context — these career construction processes are often disrupted. Research indicates that parental psychological control undermines autonomy development in Chinese university students (Wei et al., 2022), overparenting is associated with career indecision (Wang, 2023; Zhao & Li, 2022), and social uncertainty intensifies future anxiety among young people (Yu et al., 2026). As a result, many young adults find themselves unable to organize their self-concept (unclear about their interests, values, and strengths), unable to impose direction (paralyzed by uncertainty or fear), and unable to make meaning (feeling their experiences are disconnected and purposeless). The specific reasons for this disruption vary from person to person: some lack opportunities for self-exploration; some are overwhelmed by external expectations; some have stopped exploring due to the weight of uncertainty; some fear the consequences of making the "wrong" choice.

In terms of Career Adaptability, this population tends to show weakness in Control (not feeling responsible for or capable of shaping their own career), Curiosity (having stopped exploring due to confusion), and Confidence (lacking faith in their ability to make viable decisions). Concern is partially present — their awareness that they need to face the future is what brings them to seek support — but it may still manifest as undirected anxiety rather than planful orientation.

Meta-analytic evidence demonstrates that Career Adaptability can be effectively enhanced through structured interventions (Rudolph et al., 2017). Therefore, this group guidance programme is designed to provide a structured, safe environment where participants can re-engage in the career construction process. Through systematic self-exploration activities (exploring interests, values, and strengths), guided by Amundson's (2018) Active Engagement principle of dynamic and creative process, grounded in Person-Centered conditions of acceptance and empathy (Rogers, 1957), and supported by NVC (Rosenberg, 2015) for self-expression, the programme aims to reactivate participants' Curiosity, build their sense of Control, and gradually develop their Confidence — thereby restoring their capacity to organize themselves, impose direction, and make meaning of their careers.
