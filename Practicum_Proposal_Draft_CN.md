...
帮助年轻人完成 Career Construction Theory（Savickas, 2005, 2013）所描述的 career construction 过程：**组织自我（organize themselves）、赋予方向（impose direction）、建构意义（make meaning）**。

- 主要理论框架：Career Construction Theory (CCT, Savickas)
- 过程原则：Active Engagement (Amundson) — 动态、非线性、有创意
- 沟通工具：Nonviolent Communication (NVC, Rosenberg)
- 咨询态度/底色：Person-Centered (Rogers)
- 形式：线上小组辅导（Zoom + Miro 协作平台）
...
以下 needs 是基于文献和对目标群体的初步观察所做的合理推测。**实际 needs 将通过以下方式验证和调整：(1) 筛选问卷中的开放问题；(2) Session 1 的 needs check-in；(3) 根据真实成员的反馈灵活调整后续 session 内容。**

| Need | 用他们的话说 | 对应 CCT 任务 |
|---|---|---|
| 1. **被接纳** | "我想找个不被评判的地方说说话" | （基础条件） |
| 2. **想搞清楚自己到底怎么了** | "我说不清自己卡在哪" | Organize |
| 3. **了解自己** | "我到底喜欢什么、擅长什么、在乎什么？" | Organize |
| 4. **想找一点点方向感** | "不用想清楚一辈子，但让我知道下一步怎么走" | Impose direction |
...
### 这个小组是：
- ✅ 个人成长小组——帮助成员完成 CCT 描述的 career construction 过程
- ✅ 通过自我探索帮成员 **organize**（了解自己）
...
- **形式**：线上 Zoom + Miro
- **Individual counselling**：每人1小时，共4-6小时，Session 5-6后穿插
...
许多处于 emerging adulthood 阶段（Arnett, 2000）的中国年轻人对自己的未来职业和人生方向感到迷茫——不清楚自己想要什么、擅长什么、在乎什么，因而难以做出方向性的决定。文献表明，父母过度教养与大学生的 career indecision 显著相关（Wang, 2023; Zhao & Li, 2022），父母心理控制损害了年轻人自主性的发展（Wei et al., 2022），社会不确定性更进一步加剧了这一群体的 future anxiety（Yu et al., 2026）。Career Construction Theory（CCT；Savickas, 2005, 2013）为理解这群人的困境提供了有力的视角：CCT 认为个体通过三个相互交织的过程来主动建构自己的 career——组织自我（organize themselves）、赋予方向（impose direction）、建构意义（make meaning），而完成这些任务需要四种心理社会资源，即 Career Adaptability 中的 Concern、Control、Curiosity、Confidence（Savickas & Porfeli, 2012）。这群年轻人的困难恰好对应这三项任务上的受阻：自我认识的模糊使他们无法 organize，方向感的缺失意味着他们卡在 impose direction 的环节，经历之间的断裂感让他们难以 make meaning；在 4C 资源上，他们普遍表现为 Concern 部分具备但仍停留在模糊的焦虑层面，而 Control、Curiosity、Confidence 三个维度都偏弱。之所以选择 CCT 作为主框架，是因为这群人的核心问题并非"哪个职业适合我"（trait-factor matching 的问题），而是"我搞不清楚自己是谁、想要什么、该往哪走"——这正是 CCT 所关注的 self-construction 过程被阻断的表现，本小组的任务即是帮助他们恢复这一建构能力。在主框架之外，本方案还借鉴了 Amundson（2018）的 Active Engagement 模型作为实践层面的过程原则，强调动态、非线性、有创意地推进；引入 Rosenberg（2015）的 Nonviolent Communication 作为沟通工具，帮助成员在自我探索之后向重要的人（特别是父母）表达自己的想法与需要；以 Rogers（1957）的 Person-Centered 核心条件作为整个小组氛围的底色，为深入的自我探索提供必要的安全感。Rudolph 等人（2017）的 meta-analysis 证实 Career Adaptability 可以通过结构化的干预有效提升，这为本方案的可行性提供了实证支撑。

Many Chinese emerging adults (Arnett, 2000) feel lost about their future career and life direction — unclear about what they want, what they are good at, or what they truly value — and consequently struggle to make directional decisions. Literature links this to parental overinvolvement and its association with career indecision (Wang, 2023; Zhao & Li, 2022), parental psychological control undermining autonomy development (Wei et al., 2022), and social uncertainty intensifying future anxiety (Yu et al., 2026). Career Construction Theory (CCT; Savickas, 2005, 2013) offers a powerful lens for understanding their struggle: it holds that individuals actively construct their careers through three interwoven processes — organizing themselves, imposing direction, and making meaning — and that completing these tasks draws on four psychosocial resources known as Career Adaptability: Concern, Control, Curiosity, and Confidence (Savickas & Porfeli, 2012). This group's difficulties can be understood precisely as disruption in all three processes: unclear self-knowledge prevents them from organizing, paralysed direction-giving leaves them stuck on imposing direction, and fragmented life experiences make meaning-making difficult; among the four adaptability resources, Concern tends to be partially present yet remains as undirected anxiety, while Control, Curiosity, and Confidence are typically weakened. CCT is chosen as the primary framework because this group's core problem is not "which job fits me" (a trait-factor matching question) but rather "I cannot figure out who I am or where I am going" — precisely the self-construction process that CCT addresses; the task of this group is to help them restore that constructive capacity. Beyond the main framework, the programme also draws on Amundson's (2018) Active Engagement model as a process principle for practice, emphasising dynamic, non-linear, and creative engagement; it introduces Rosenberg's (2015) Nonviolent Communication as a communication tool to help members express their thoughts and needs to significant others (particularly parents) after their self-exploration; and it grounds the overall group atmosphere in Rogers' (1957) Person-Centered core conditions to provide the safety needed for genuine exploration. Meta-analytic evidence (Rudolph et al., 2017) confirms that Career Adaptability can be effectively enhanced through structured intervention, supporting the feasibility of this approach.
...
整个方案共九次小组会议，沿着 CCT 的 career construction 过程逐步展开，并融入了《事業輔導與生涯規劃》教材中的本地化方法。最初的会议用于建立小组的安全感与共同规则，进行 needs check-in，并通过"关于未来方向，你到目前为止已经做过哪些思考或尝试"这类提问来评估并激活每位成员的 Career Concern。接下来几次进入向内探索的阶段，分别聚焦于兴趣、优势/技能、以及价值观——通过 RIASEC 兴趣讨论和 flow 时刻回忆来探索"什么让我有能量"（参考《事業輔導與生涯規劃》單元六、七），通过技能清单与"朋友眼中的我"的同伴反馈来识别"我擅长什么"（参考單元九的能力评估方法），再通过 Values Card Sort 与"如果没有任何限制"这样的假设性提问来澄清"什么对我真正重要"（参考單元八的价值观探索方法）。中段是一个转折点，引导成员把前面累积的发现整合起来，通过 possible selves brainstorm 思考"我看到什么方向或可能性"，并面对内外部的障碍以及可用的支持资源。后段则转向外部表达：介绍 NVC 的四组件模型——观察、感受、需要、请求——并通过角色扮演让成员练习如何向父母或其他重要的人表达自己的想法和需要；之后帮助成员制定一个具体、可行、与个人价值一致的小行动步骤。最后一次会议作为收尾，通过回顾 Miro 画布的全貌、写一封给未来自己的信、以及简短的 closing ceremony，完成 make meaning 的过程。整个九次的过程中，Miro 协作画布作为可视化工具贯穿始终，每位成员有自己的专属区域，每次 session 后在画布上记录当次的探索发现，到最后累积出一张属于自己的"自我探索地图"，这本身就是 career construction 的可视化产物。需要说明的是，每次会议虽然都有一个主要的探索方向，但讨论并不会被严格限制在单一主题——这与 Amundson 的 Active Engagement 模型一致：成员可能在做某个活动时自然触及其他维度，这种自然流动是被鼓励的。生涯评估面谈技巧（参考單元四、五）将主要融入个别辅导环节。

The programme consists of nine group sessions unfolding along CCT's career construction process and incorporating localised methods from the HKEdCity *Career Guidance and Life Planning* curriculum. The opening session focuses on establishing group safety and shared norms, conducting a needs check-in, and using questions such as "what thoughts or attempts about your future direction have you already made?" to assess and activate each member's Career Concern. The next few sessions move into inward exploration, focusing in turn on interests, strengths/skills, and values — exploring "what gives me energy" through RIASEC discussion and flow moment recall (drawing on Units 6 and 7), identifying "what I am good at" through skills inventories and "how friends see me" peer feedback (drawing on Unit 9 on competence assessment), and clarifying "what truly matters to me" through Values Card Sort and hypothetical prompts such as "if there were no limits…" (drawing on Unit 8 on values exploration). The middle session serves as a turning point, guiding members to integrate their accumulated discoveries through possible selves brainstorming around "what direction or possibility do I see," and to address both internal and external barriers along with available supports. The later sessions turn toward outward expression: introducing the four components of NVC — observation, feeling, need, and request — and using role play to practise expressing oneself to parents or other significant others; following this, members develop a concrete, feasible, values-aligned small action step. The final session closes the journey by reviewing the entire Miro canvas, writing a letter to one's future self, and concluding with a brief closing ceremony, completing the make-meaning process. Throughout all nine sessions, Miro serves as a visual collaboration tool — each member has their own dedicated space, recording discoveries after every session, and gradually accumulating a personal "self-exploration map" that itself becomes the visible product of career construction. Importantly, while each session has a primary exploration direction, discussion is not strictly confined to a single theme — consistent with Amundson's Active Engagement model, members may naturally touch on other dimensions during any given activity, and such fluid movement is encouraged. Career assessment interview techniques (drawing on Units 4 and 5) will be integrated primarily into the individual counselling component.
...
- [ ] 发给督导 approve 本 proposal
- [ ] 确认 CCT 作为主框架是否 OK
- [ ] 确认他提到的"career counselling domains 图"的具体 reference
- [ ] 确认 hkedcity 资源内容
- [ ] 确认线上 Zoom + Miro 是否 OK
- [ ] 确认 9次×2h 的安排
- [ ] Approve 后开始 consent + 招募
...
Savickas, M. L. (2013). Career construction theory and practice. In R. W. Lent & S. D. Brown (Eds.), *Career development and counseling* (2nd ed., pp. 147–183). Wiley.
...
Wei, S., Teo, T., Malpique, A., & Lausen, A. (2022). Parental autonomy support and Chinese university students' behavior regulation. *Frontiers in Psychology*, 13, 735570.
